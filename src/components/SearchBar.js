...
const formatNumber = (date) =>
  date instanceof Date && !isNaN(date) ? format(date, "dd") : "--";
    ...
    >
      ...
      <div >
        <div className="date-time-selectors-container">
          ...
          {/* SVG de flecha en el centro */}
          <div
            className="arrow-icon"
            style={{ position: "relative", top: 50, display: "none" }}
          >
            <svg
              width="30"
              height="30"
      ...
      <Button
        variant="contained"
        className="btn-buscar-sb"
        color="primary"
        sx={{ backgroundColor: "#d60812", width: "100%", margin: "0 auto" }}
